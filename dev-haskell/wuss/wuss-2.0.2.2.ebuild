...
CABAL_CHDEPS=(
	'base ^>=4.18.0.0 || ^>=4.19.0.0 || ^>=4.20.0.0' 'base          >=4.18'
)
...
RDEPEND=">=dev-lang/ghc-9.6.2:=
	...
	|| ( ( >=dev-haskell/data-default-0.7.0:=[profile?] <dev-haskell/data-default-0.8:=[profile?] )
		( >=dev-haskell/data-default-0.8.0.0:=[profile?] <dev-haskell/data-default-0.9:=[profile?] ) )
